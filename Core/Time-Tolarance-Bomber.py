...
while True:
    ...
    pn = remsp(pn)
    os.system('clear')
    os.system('toilet  "   Timer" | lolcat')
    os.system('echo "\t\t\e[4;34m Type only value for seconds.   ex:-3\e[0m" | lolcat')
    os.system('echo "\t\t\e[4;34m Type valuem for minutes.      ex:-5m\e[0m" | lolcat')
    os.system('echo "\t\t\e[4;34m Type valueh for Hours.        ex:-5h\e[0m" | lolcat')
    os.system('echo "\t\t\e[4;34m Type valued for Days.         ex:-5d\e[0m" | lolcat')
    print(random.choice(colors))
    timer = input("Input Timer:- ")
    tolarance = input("Input Tolarance:- ")
    if pn == '9940152460':
        os.system('clear')
        sys.exit("\t\t\t    I'LL NOT BETRAY MY MASTER")
    if pn == '7305574234':
        os.system('clear')
        sys.exit("\t\t\t    I'LL NOT BETRAY MY MASTER")
