...
def verCheck():
    ...
    if ver_sc == 200:
        ...
        if ver_current == github_ver:
            ...
            sleep(2)
            system("git clone https://github.com/navin-hariharan/Master-Bomber")
            system("cd Master-Bomber;cp -r -f * .. > temp;cd ..;rm -rf  Master-Bomber >> temp;rm update.Navin >> temp;rm temp;chmod +x *")
    else:
